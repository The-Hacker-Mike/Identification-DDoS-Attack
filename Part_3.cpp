...
class ConexionesComputadora
{
    ...
    /*bool operator==(const ConexionesComputadora& otro) const{
...
struct myHash{
    ...
    size_t operator()(const ConexionesComputadora& cc)const
    {
    size_t hashingRes = hash<string>()(cc.nombre);
    return shortRes;
    }
};*/
...
int main(int argc, const char * argv[]) {
    ...
    /*for(auto it = SiReto.begin(); it != SiReto.end(); it++ ){
        cout << "En si reto: "<<*it << endl;
    }*/
    ...
    //cout << "Tamaño de si reto: "<< SiReto.size() << endl;
    //cout << "Tamaño de no reto: "<< NoReto.size() <<endl;
    //cout << "suma: " << SiReto.size() + NoReto.size() <<endl;
    //cout << "Tamaño diccionario: " << TodasConexiones.size() << endl;
    ...
    /*Jessica: 10.109.228.102
     Sarah: 10.109.228.68
     Mary: 10.109.228.113
     Thomas: 10.109.228.140
     Jeffrey: 10.109.228.150
     */
